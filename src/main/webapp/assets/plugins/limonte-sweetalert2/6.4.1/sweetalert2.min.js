!function (e, t) {
    ...
    var e = {
        ...
        var n = c(), r = A(n, o.input), i = A(n, o.file), a = n.querySelector("." + o.range + " input"), l = n.querySelector("." + o.range + " output"), u = A(n, o.select), d = n.querySelector("." + o.checkbox + " input"), p = A(n, o.textarea);
        ...
        return new Promise(function (t, n) {
            ...
            for (var L = function (n) {
                ...
                var o = t || window.event, r = o.target || o.srcElement, a = b(), l = w(), u = a === r || a.contains(r), c = l === r || l.contains(r);
                switch (o.type) {
                    case"mouseover":
                    case"mouseup":
                ...
                switch (s.input) {
                    ...
                    case"radio":
                        ...
                        l.innerHTML = "", G = function (e) {
                            for (var t in e) {
                                var n = document.createElement("input"), r = document.createElement("label"), i = document.createElement("span");
