...
!function (e) {
    "object" == typeof exports && "object" == typeof module ? e(require("/assets/plugins/editor/lib/codemirro")) : "function" == typeof define && define.amd ? define(["/assets/plugins/editor/lib/codemirro"], e) : e(CodeMirror)
}(function (e) {
    ...
    "object" == typeof exports && "object" == typeof module ? e(require("/assets/plugins/editor/lib/codemirror")) : "function" == typeof define && define.amd ? define(["/assets/plugins/editor/lib/codemirro"], e) : e(CodeMirror)
}(function (e) {
    function t(e, t, i) {
    ...
    e.defineExtension("annotateScrollbar", function (e) {
        ...
        var e = this.cm, t = (e.getWrapperElement().clientHeight - e.display.barHeight - 2 * this.buttonHeight) / e.heightAtLine(e.lastLine() + 1, "local");
    ...
    function t(t) {
        ...
        for (var i = t.listSelections(), o = [], l = 0; l < i.length; l++) {
            ...
            var f = t.getOption("autoCloseTags"), g = "html" == h.mode.configuration, p = "object" == typeof f && f.dontCloseTags || g && a, m = "object" == typeof f && f.indentTags || g && s, v = u.tagName;
    ...
    function n(e, t, i) {
        var n = e.state.foldGutter.options, a = t, s = e.foldOption(n, "minFoldSize"), l = e.foldOption(n, "rangeFinder");
    ...
    var u = e.Pos, f = "A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD", g = f + "-:.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040", p = new RegExp("<(/?)([" + f + "][" + g + "]*)", "g");
